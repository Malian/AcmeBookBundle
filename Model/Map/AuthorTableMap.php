...
use Acme\Bundle\BookBundle\Model\AuthorQuery;
...
class AuthorTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Acme.Bundle.BookBundle.Model.Map.AuthorTableMap';
     ...
     */
    const OM_CLASS = '\\Acme\\Bundle\\BookBundle\\Model\\Author';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Acme.Bundle.BookBundle.Model.Author';
    ...
    protected static $fieldNames = array (
        ...
        self::TYPE_STUDLYPHPNAME => array('id', 'firstName', 'lastName', ),
        self::TYPE_COLNAME       => array(AuthorTableMap::ID, AuthorTableMap::FIRST_NAME, AuthorTableMap::LAST_NAME, ),
        self::TYPE_RAW_COLNAME   => array('ID', 'FIRST_NAME', 'LAST_NAME', ),
    ...
    protected static $fieldKeys = array (
        ...
        self::TYPE_STUDLYPHPNAME => array('id' => 0, 'firstName' => 1, 'lastName' => 2, ),
        self::TYPE_COLNAME       => array(AuthorTableMap::ID => 0, AuthorTableMap::FIRST_NAME => 1, AuthorTableMap::LAST_NAME => 2, ),
        self::TYPE_RAW_COLNAME   => array('ID' => 0, 'FIRST_NAME' => 1, 'LAST_NAME' => 2, ),
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\Acme\\Bundle\\BookBundle\\Model\\Author');
    ...
    {
        $this->addRelation('Book', '\\Acme\\Bundle\\BookBundle\\Model\\Book', RelationMap::ONE_TO_MANY, array('id' => 'author_id', ), null, null, 'Books');
    } // buildRelations()
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Acme\Bundle\BookBundle\Model\Author) { // it's a model object
