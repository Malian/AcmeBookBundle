...
namespace Acme\Bundle\BookBundle\Model\Map;

use Acme\Bundle\BookBundle\Model\Book;
use Acme\Bundle\BookBundle\Model\BookQuery;
...
class BookTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Acme.Bundle.BookBundle.Model.Map.BookTableMap';
     ...
     */
    const OM_CLASS = '\\Acme\\Bundle\\BookBundle\\Model\\Book';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.Acme.Bundle.BookBundle.Model.Book';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Title', 'Isbn', 'AuthorId', ),
        self::TYPE_STUDLYPHPNAME => array('id', 'title', 'isbn', 'authorId', ),
        self::TYPE_COLNAME       => array(BookTableMap::ID, BookTableMap::TITLE, BookTableMap::ISBN, BookTableMap::AUTHOR_ID, ),
        self::TYPE_RAW_COLNAME   => array('ID', 'TITLE', 'ISBN', 'AUTHOR_ID', ),
        self::TYPE_FIELDNAME     => array('id', 'title', 'isbn', 'author_id', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Title' => 1, 'Isbn' => 2, 'AuthorId' => 3, ),
        self::TYPE_STUDLYPHPNAME => array('id' => 0, 'title' => 1, 'isbn' => 2, 'authorId' => 3, ),
        self::TYPE_COLNAME       => array(BookTableMap::ID => 0, BookTableMap::TITLE => 1, BookTableMap::ISBN => 2, BookTableMap::AUTHOR_ID => 3, ),
        self::TYPE_RAW_COLNAME   => array('ID' => 0, 'TITLE' => 1, 'ISBN' => 2, 'AUTHOR_ID' => 3, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'title' => 1, 'isbn' => 2, 'author_id' => 3, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, )
    );
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\Acme\\Bundle\\BookBundle\\Model\\Book');
        $this->setPackage('src.Acme.Bundle.BookBundle.Model');
    ...
    {
        $this->addRelation('Author', '\\Acme\\Bundle\\BookBundle\\Model\\Author', RelationMap::MANY_TO_ONE, array('author_id' => 'id', ), null, null);
    } // buildRelations()
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Acme\Bundle\BookBundle\Model\Book) { // it's a model object
