...
namespace Acme\Bundle\BookBundle\Model\Base;

use \Exception;
use \PDO;
use Acme\Bundle\BookBundle\Model\Book as ChildBook;
use Acme\Bundle\BookBundle\Model\BookQuery as ChildBookQuery;
use Acme\Bundle\BookBundle\Model\Map\BookTableMap;
...
abstract class BookQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \Acme\Bundle\BookBundle\Model\Base\BookQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\Acme\\Bundle\\BookBundle\\Model\\Book', $modelAlias = null)
    {
    ...
    {
        if ($criteria instanceof \Acme\Bundle\BookBundle\Model\BookQuery) {
            return $criteria;
        }
        $query = new \Acme\Bundle\BookBundle\Model\BookQuery();
        if (null !== $modelAlias) {
    ...
    /**
     * Filter the query by a related \Acme\Bundle\BookBundle\Model\Author object
     *
     * @param \Acme\Bundle\BookBundle\Model\Author|ObjectCollection $author The related object(s) to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return ChildBookQuery The current query, for fluid interface
     */
    ...
    {
        if ($author instanceof \Acme\Bundle\BookBundle\Model\Author) {
            return $this
            ...
            throw new PropelException('filterByAuthor() only accepts arguments of type \Acme\Bundle\BookBundle\Model\Author or Collection');
        }
    }
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return   \Acme\Bundle\BookBundle\Model\AuthorQuery A secondary query class using the current class as primary query
     */
    public function useAuthorQuery($relationAlias = null, $joinType = Criteria::LEFT_JOIN)
    {
        return $this
            ->joinAuthor($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'Author', '\Acme\Bundle\BookBundle\Model\AuthorQuery');
    }
