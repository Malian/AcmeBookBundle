...
abstract class Author implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Acme\\Bundle\\BookBundle\\Model\\Map\\AuthorTableMap';
    ...
    /**
     * Initializes internal state of Acme\Bundle\BookBundle\Model\Base\Author object.
     */
     ...
     * @return   \Acme\Bundle\BookBundle\Model\Author The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[AuthorTableMap::ID] = true;
        }
    ...
    public function setFirstName($v)
    {
        ...
        if ($this->first_name !== $v) {
            $this->first_name = $v;
            $this->modifiedColumns[AuthorTableMap::FIRST_NAME] = true;
        }
    ...
    public function setLastName($v)
    {
        ...
        if ($this->last_name !== $v) {
            $this->last_name = $v;
            $this->modifiedColumns[AuthorTableMap::LAST_NAME] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException("Error populating \Acme\Bundle\BookBundle\Model\Author object", 0, $e);
        }
    }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Acme\Bundle\BookBundle\Model\Author (or compatible) type.
     ...
     *
     * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return                 \Acme\Bundle\BookBundle\Model\Author Clone of current object.
     * @throws PropelException
     */
    ...
    public function initBooks($overrideExisting = true)
    {
        ...
        $this->collBooks->setModel('\Acme\Bundle\BookBundle\Model\Book');
    }
