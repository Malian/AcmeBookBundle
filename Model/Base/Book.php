...
abstract class Book implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Acme\\Bundle\\BookBundle\\Model\\Map\\BookTableMap';
    ...
    /**
     * Initializes internal state of Acme\Bundle\BookBundle\Model\Base\Book object.
     */
     ...
     * @return   \Acme\Bundle\BookBundle\Model\Book The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[BookTableMap::ID] = true;
        }
    ...
    public function setTitle($v)
    {
        ...
        if ($this->title !== $v) {
            $this->title = $v;
            $this->modifiedColumns[BookTableMap::TITLE] = true;
        }
    ...
    public function setIsbn($v)
    {
        ...
        if ($this->isbn !== $v) {
            $this->isbn = $v;
            $this->modifiedColumns[BookTableMap::ISBN] = true;
        }
    ...
    public function setAuthorId($v)
    {
        ...
        if ($this->author_id !== $v) {
            $this->author_id = $v;
            $this->modifiedColumns[BookTableMap::AUTHOR_ID] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException("Error populating \Acme\Bundle\BookBundle\Model\Book object", 0, $e);
        }
    }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Acme\Bundle\BookBundle\Model\Book (or compatible) type.
     ...
     *
     * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return                 \Acme\Bundle\BookBundle\Model\Book Clone of current object.
     * @throws PropelException
     */
