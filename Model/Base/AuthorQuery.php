...
use \Exception;
use \PDO;
use Acme\Bundle\BookBundle\Model\Author as ChildAuthor;
use Acme\Bundle\BookBundle\Model\AuthorQuery as ChildAuthorQuery;
use Acme\Bundle\BookBundle\Model\Map\AuthorTableMap;
...
abstract class AuthorQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \Acme\Bundle\BookBundle\Model\Base\AuthorQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\Acme\\Bundle\\BookBundle\\Model\\Author', $modelAlias = null)
    {
    ...
    {
        if ($criteria instanceof \Acme\Bundle\BookBundle\Model\AuthorQuery) {
            return $criteria;
        }
        $query = new \Acme\Bundle\BookBundle\Model\AuthorQuery();
        if (null !== $modelAlias) {
    ...
    /**
     * Filter the query by a related \Acme\Bundle\BookBundle\Model\Book object
     *
     * @param \Acme\Bundle\BookBundle\Model\Book|ObjectCollection $book  the related object to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return ChildAuthorQuery The current query, for fluid interface
     */
    ...
    {
        if ($book instanceof \Acme\Bundle\BookBundle\Model\Book) {
            return $this
            ...
            throw new PropelException('filterByBook() only accepts arguments of type \Acme\Bundle\BookBundle\Model\Book or Collection');
        }
    }
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return   \Acme\Bundle\BookBundle\Model\BookQuery A secondary query class using the current class as primary query
     */
    public function useBookQuery($relationAlias = null, $joinType = Criteria::LEFT_JOIN)
    {
        return $this
            ->joinBook($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'Book', '\Acme\Bundle\BookBundle\Model\BookQuery');
    }
